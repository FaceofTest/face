namespace 人脸1
{
    partial class HolidaySet
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.已有假列表 = new System.Windows.Forms.Label();
            ...
            // 已有假列表
            // 
            this.已有假列表.AutoSize = true;
            this.已有假列表.Location = new System.Drawing.Point(12, 107);
            this.已有假列表.Name = "已有假列表";
            this.已有假列表.Size = new System.Drawing.Size(77, 13);
            this.已有假列表.TabIndex = 3;
            this.已有假列表.Text = "添加假名称";
            // 
            // button1
            // 
            ...
            this.Text = "假类设置";
            this.Load += new System.EventHandler(this.HolidaySet_Load);
        ...
        private System.Windows.Forms.Label 已有假列表;
